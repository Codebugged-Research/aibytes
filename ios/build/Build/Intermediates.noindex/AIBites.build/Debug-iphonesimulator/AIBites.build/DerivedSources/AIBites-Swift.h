...
#ifndef AIBITES_SWIFT_H
#define AIBITES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AIBites",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7AIBites8Narrator")
@interface Narrator : NSObject <AVSpeechSynthesizerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)speechSynthesizer:(AVSpeechSynthesizer * _Nonnull)s didFinishSpeechUtterance:(AVSpeechUtterance * _Nonnull)u;
- (void)speechSynthesizer:(AVSpeechSynthesizer * _Nonnull)s didCancelSpeechUtterance:(AVSpeechUtterance * _Nonnull)u;
@end
